import 'package:app/src/core/common/constants/app_colors.dart';
  ...
  static AppThemeData lerp(AppThemeData a, AppThemeData b, double t) {
    ...
    return AppThemeData(
      ...
      settingsListIconBackground: Color.lerp(
        a.settingsListIconBackground,
        b.settingsListIconBackground,
        t,
      )!,
  ...
  AppThemeVariants(List<Color> swatch)
      : themes = [
          AppThemeData(
            ...
            accentNegative: Colors.white, // To-do: change the white
            taskRing: swatch[4],
            taskIcon: AppColors.white,
            settingsText: AppColors.white,
            settingsLabel: Colors.white, // To-do: change the white
            settingsCta: swatch[3],
            settingsListIconBackground: swatch[2],
            settingsInactiveIconBackground: swatch[2],
            inactiveThemePanelRing: Colors.white, // To-do: change the white
            overlayStyle: SystemUiOverlayStyle.light,
          ),
          AppThemeData(
            primary: AppColors.white,
            secondary: Colors.white, // To-do: change the white
            accent: swatch[0],
            accentNegative: AppColors.white,
            taskRing: Colors.white, // To-do: change the white
            taskIcon: swatch[0],
            settingsText: swatch[0],
            settingsLabel: Colors.white, // To-do: change the white
            settingsCta: swatch[0],
            settingsListIconBackground: swatch[0],
            settingsInactiveIconBackground:
                Colors.white, // To-do: change the white
            inactiveThemePanelRing: Colors.white, // To-do: change the white
            overlayStyle: SystemUiOverlayStyle.dark,
          ),
          AppThemeData(
            primary: Colors.white, // To-do: change the white
            secondary: Colors.white, // To-do: change the white
            accent: swatch[0],
            accentNegative: AppColors.white,
            taskRing: Colors.white, // To-do: change the white
